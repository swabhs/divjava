...
public class ParserDD {
	...
	public Result run(double[][] weights) {
		...
		UnigramHammingDist<Integer> dist = new UnigramHammingDist<Integer>();
		DualDecompositionHelper<Integer> helper = new DualDecompositionHelper<Integer>();
		...
		while (iter <= maxIterations) {
			...
			tags2 = dist.run(bestTree, dd, tagSet);	
