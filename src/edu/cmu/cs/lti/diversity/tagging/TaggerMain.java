...
import edu.cmu.cs.lti.diversity.utils.Tuple;
...
public class TaggerMain {
    ...
    public static void main(String[] args) {
        ...
        for (example = 0; example < sentences.size(); example++) {
             ...
             * System.out.println(bestTagSeq); avgAccBest +=
             * evaluate(trueTagSeqs.get(c), bestTagSeq);
             * 
             * if (iter == -1) { System.err.println("Does NOT converge\n"); }
             * else { List<String> predTagSeq = result.secondBestTagSeq;
             * System.out.println(predTagSeq);
             * System.err.println("Converges in " + iter + " iterations\n");
             * convergenceRatio += 1; averageIterations += iter;
